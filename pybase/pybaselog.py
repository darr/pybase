...
# -*- coding: utf-8 -*-
########################################
# File name : pybaselog.py
# Create date : 2013-06-20 22:30
# Modified date : 2018-10-19 13:36
# Author : DARREN
...
def out_put_log(level, content, log_path="", stack_layer=2):
...
def test_compare_value(real_value, expected_value):
    if real_value != expected_value:
        auto_test_error("real:%s expected:%s" % (real_value, expected_value))
    else:
        auto_test_debug("real:%s expected:%s" % (real_value, expected_value))
